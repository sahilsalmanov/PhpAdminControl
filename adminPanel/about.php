...
if($_POST) {
    ...
    $sorgu = $connectToSql -> query("delete from haqqimizda");
    $sorgu = $connectToSql -> query("insert into haqqimizda (aciqlama) values ('$aciqlama')");
    if($sorgu) {
...
$sorgu = $connectToSql -> query("select * from haqqimizda");
